...
const homeCss = `
  ...
  @media (max-width: 480px) {
    .hero { grid-template-columns: 1fr; text-align: center; padding: 1.75rem 1.25rem; }
    .hero-sub { max-width: 100%; }
    .hero-deco { justify-content: center; margin-top: 0.5rem; }
    .hero-star { width: 56px; height: 56px; }
  }

  .stats-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 16px; }

  .pv-stat { border-radius: 20px; padding: 1.25rem; position: relative; overflow: hidden; min-height: 120px; display: flex; flex-direction: column; justify-content: space-between; }
  ...
  .pv-stat-value { font-family: 'DM Serif Display', serif; font-size: 32px; line-height: 1; margin-bottom: 3px; }
  ...
  .pv-feature:hover { transform: translateY(-3px); box-shadow: 0 8px 30px rgba(0, 0, 0, 0.15); }
  ...
  .pv-feature-desc { font-size: 13px; line-height: 1.5; }
  ...
  @media (max-width: 480px) {
    .pv-feature { grid-template-columns: 1fr; min-height: auto; padding: 1.25rem; }
    .pv-feature-icon { align-self: flex-start; }
  }
`
